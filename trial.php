  ...
  //alert(finalJSON);
         ...
         function Cancel_tag(){
          ...
          prob = 1 ;
           ...
           var vname = $("#Name_input").val();
           var tg = $("#Tag_input").val();
           var d = $("#Description_input").val();
           var use = '<?php echo $user ;?>';
           var img = '<?php echo $n ;?>';
           var v = sele;
...
$.post("osb.php", //Required URL of the page on server
...
$("#form")[0].reset();
 ...
 var file_data = $('#file').prop('files')[0];
                 ...
                 form_data.append('map',img);
                 form_data.append('val',v);
                 $.ajax({
                     url: 'audio.php', // point to server-side PHP script
                ...
                //       alert(response);
                 ...
                 form_data.append('val',v);
                 $.ajax({
                     url: 'img.php', // point to server-side PHP script
                     dataType: 'text', // what to expect back from the PHP script
                     cache: false,
                     contentType: false,
                     processData: false,
